...
var havana = addCity({ "latitude": 23, "longitude": -82 }, "Havana - Row Material - Cotton King");
var toronto = addCity({ "latitude": 43.8163, "longitude": -79.4287 }, "Toronto - Fiber - Tearfill");
var paris = addCity({ "latitude": 48.8567, "longitude": 2.3510 }, "Paris - Fabric - SoftTouch");

var la = addCity({ "latitude": 34.3, "longitude": -118.15 }, "Los Angeles - Garment - StyleMeUp");
...
plane.adapter.add("scale", (scale, target) => {
    return 0.6 * (1 - (Math.abs(0.5 - target.position)));
})
...
planeImage.fill = chart.colors.getIndex(9).brighten(0.2);
